...
CREATE TABLE CLASE (DIA VARCHAR NOT NULL, HORAINICIO TIMESTAMP NOT NULL, HORAFIN TIMESTAMP, ASIGNATURA_REFERENCIA INTEGER NOT NULL, GRUPO_ID VARCHAR NOT NULL, PRIMARY KEY (DIA, HORAINICIO, GRUPO_ID))
