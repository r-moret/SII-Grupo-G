...
CREATE TABLE GRUPO (ID VARCHAR NOT NULL, ASIGNAR BOOLEAN, CURSO INTEGER NOT NULL, INGLES BOOLEAN NOT NULL, LETRA VARCHAR NOT NULL, PLAZAS INTEGER, TURNO VARCHAR NOT NULL, VISIBLE BOOLEAN, TITULACION_CODIGO INTEGER NOT NULL, PRIMARY KEY (ID))
...
CREATE TABLE DATOSALUMNADO (DNI VARCHAR NOT NULL, APELLIDO1 VARCHAR, APELLIDO2 VARCHAR, CPNOTIFICACION INTEGER, CREDITOSCF DOUBLE, CREDITOSFB DOUBLE, CREDITOSOB DOUBLE, CREDITOSOP DOUBLE, CREDITOSPE DOUBLE, CREDITOSSUPERADOS DOUBLE, CREDITOSTF DOUBLE, DIRECCIONNOTIFICACION VARCHAR, EMAILINSTITUCIONAL VARCHAR, EMAILPERSONAL VARCHAR, FECHAMATRICULA TIMESTAMP, GRUPOSASIGNADOS VARCHAR, LOCALIDADNOTIFICACION VARCHAR, MOVIL VARCHAR, NOMBRE VARCHAR, NOTAMEDIA DOUBLE, NUMARCHIVO INTEGER, NUMEXPEDIENTE INTEGER, PROVINCIANOTIFICACION VARCHAR, TELEFONO VARCHAR, TURNOPREFERENTE VARCHAR, PRIMARY KEY (DNI))
...
CREATE TABLE GRUPO_GRUPO (relacionados_ID VARCHAR NOT NULL, relacionadoCon_ID VARCHAR NOT NULL, PRIMARY KEY (relacionados_ID, relacionadoCon_ID))
...
ALTER TABLE GRUPO_GRUPO ADD CONSTRAINT FK_GRUPO_GRUPO_relacionados_ID FOREIGN KEY (relacionados_ID) REFERENCES GRUPO (ID)
ALTER TABLE GRUPO_GRUPO ADD CONSTRAINT FK_GRUPO_GRUPO_relacionadoCon_ID FOREIGN KEY (relacionadoCon_ID) REFERENCES GRUPO (ID)
